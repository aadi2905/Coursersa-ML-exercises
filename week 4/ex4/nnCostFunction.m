...
%Theta1=rehsape(nn_params(1:10025),25,401);
%Theta2=reshape(nn_parama(10026:10285),10,26);
...
m = size(X, 1);  % no of instances 5000
          
% You need to return the following variables correctly 
J = 0;
Theta1_grad = zeros(size(Theta1));
Theta2_grad = zeros(size(Theta2));  % will need to unroll later
...
%               first time.
%(delta3 * Theta2 .* sigmoidGradient([ones(size(Z2), 1) Z2]))(:, 2:end);
delta3= Y-a3;
